...
class PickledImageProvider(object):
    def __init__(self, obj_path):
        self.obj_path = "C:\\Users\msi\Desktop\Soohyun\Deep2\zi2zi-master\experiment\data\\train.obj"
        self.examples = self.load_pickled_examples()

    def load_pickled_examples(self):
        with open(self.obj_path, "r") as of:
            examples = list()
            while True:
                try:
                    e = pickle.load(of)
...
class TrainDataProvider(object):
    def __init__(self, data_dir, train_name="C:\\Users\msi\Desktop\Soohyun\Deep2\zi2zi-master\experiment\data\\train.obj",
                 val_name="C:\\Users\msi\Desktop\Soohyun\Deep2\zi2zi-master\experiment\data\\val.obj", filter_by=None):
